...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-common-tags/node_modules/common-tags/lib/removeNonPrintingValuesTransformer/removeNonPrintingValuesTransformer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-common-tags/node_modules/common-tags/lib/removeNonPrintingValuesTransformer/removeNonPrintingValuesTransformer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-common-tags/node_modules/common-tags/lib/removeNonPrintingValuesTransformer/</a> &#187; removeNonPrintingValuesTransformer.js</div>
</div>
<div class="body">
...
&nbsp;
var isValidValue = <span class="fstat-no" title="function not covered" >function isValidValue(x) {</span>
<span class="cstat-no" title="statement not covered" >  return x != null &amp;&amp; !(0, _isNan2.default)(x) &amp;&amp; typeof x !== 'boolean';</span>
};
&nbsp;
var removeNonPrintingValuesTransformer = function removeNonPrintingValuesTransformer() {
  return {
    onSubstitution: <span class="fstat-no" title="function not covered" >function onSubstitution(substitution) {</span>
<span class="cstat-no" title="statement not covered" >      if (Array.isArray(substitution)) {</span>
<span class="cstat-no" title="statement not covered" >        return substitution.filter(isValidValue);</span>
      }
<span class="cstat-no" title="statement not covered" >      if (isValidValue(substitution)) {</span>
