...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-common-tags/node_modules/common-tags/lib/replaceSubstitutionTransformer/replaceSubstitutionTransformer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-common-tags/node_modules/common-tags/lib/replaceSubstitutionTransformer/replaceSubstitutionTransformer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-common-tags/node_modules/common-tags/lib/replaceSubstitutionTransformer/</a> &#187; replaceSubstitutionTransformer.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      if (replaceWhat == null || replaceWith == null) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('replaceSubstitutionTransformer requires at least 2 arguments.');</span>
      }
&nbsp;
      // Do not touch if null or undefined
<span class="cstat-no" title="statement not covered" >      if (substitution == null) {</span>
<span class="cstat-no" title="statement not covered" >        return substitution;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        return substitution.toString().replace(replaceWhat, replaceWith);</span>
      }
    }
  };
};
