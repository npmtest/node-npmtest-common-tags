...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-common-tags/node_modules/common-tags/lib/splitStringTransformer/splitStringTransformer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-common-tags/node_modules/common-tags/lib/splitStringTransformer/splitStringTransformer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-common-tags/node_modules/common-tags/lib/splitStringTransformer/</a> &#187; splitStringTransformer.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      if (splitBy != null &amp;&amp; typeof splitBy === 'string') {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof substitution === 'string' &amp;&amp; substitution.includes(splitBy)) {</span>
<span class="cstat-no" title="statement not covered" >          substitution = substitution.split(splitBy);</span>
        }
      } else {
<span class="cstat-no" title="statement not covered" >        throw new Error('You need to specify a string character to split by.');</span>
      }
