...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-common-tags/node_modules/common-tags/lib/stripIndentTransformer/stripIndentTransformer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-common-tags/node_modules/common-tags/lib/stripIndentTransformer/stripIndentTransformer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-common-tags/node_modules/common-tags/lib/stripIndentTransformer/</a> &#187; stripIndentTransformer.js</div>
</div>
<div class="body">
...
var stripIndentTransformer = function stripIndentTransformer() {
  ...
  return {
    onEndResult: <span class="fstat-no" title="function not covered" >function onEndResult(endResult) {</span>
<span class="cstat-no" title="statement not covered" >      if (type === 'initial') {</span>
        // remove the shortest leading indentation from each line
<span class="cstat-no" title="statement not covered" >        var match = endResult.match(/^[ \t]*(?=\S)/gm);</span>
        // return early if there's nothing to strip
<span class="cstat-no" title="statement not covered" >        if (match === null) {</span>
<span class="cstat-no" title="statement not covered" >          return endResult;</span>
        }
<span class="cstat-no" title="statement not covered" >        var indent = Math.min.apply(Math, (0, _toConsumableArray3.default)(match.map(<span class="fstat-no" title="function not covered" >function (el) {</span></span>
<span class="cstat-no" title="statement not covered" >          return el.length;</span>
        })));
<span class="cstat-no" title="statement not covered" >        var regexp = new RegExp('^[ \\t]{' + indent + '}', 'gm');</span>
<span class="cstat-no" title="statement not covered" >        endResult = indent &gt; 0 ? endResult.replace(regexp, '') : endResult;</span>
      } else <span class="cstat-no" title="statement not covered" >if (type === 'all') {</span>
        // remove all indentation from each line
<span class="cstat-no" title="statement not covered" >        endResult = endResult.split('\n').map(<span class="fstat-no" title="function not covered" >function (line) {</span></span>
<span class="cstat-no" title="statement not covered" >          return line.trimLeft();</span>
        }).join('\n');
      } else {
