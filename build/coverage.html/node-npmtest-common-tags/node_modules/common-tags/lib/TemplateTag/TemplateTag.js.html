...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-common-tags/node_modules/common-tags/lib/TemplateTag/TemplateTag.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-common-tags">npmtest-common-tags (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-common-tags/node_modules/common-tags/lib/TemplateTag/TemplateTag.js</span></h1>
    <h2>
        
        Statements: <span class="metric">57.5% <small>(23 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">56.41% <small>(22 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-common-tags/node_modules/common-tags/lib/TemplateTag/</a> &#187; TemplateTag.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (transformers.length &amp;&amp; Array.isArray(transformers[0])) {
<span class="cstat-no" title="statement not covered" >      transformers = transformers[0];</span>
    }
&nbsp;
...
&nbsp;
  (0, _createClass3.default)(TemplateTag, [{
    key: 'tag',
    value: <span class="fstat-no" title="function not covered" >function tag() {</span>
...
<span class="cstat-no" title="statement not covered" >        return this.interimTag.bind(this, args.shift());</span>
      }
&nbsp;
      // else, return a transformed end result of processing the template with our tag
<span class="cstat-no" title="statement not covered" >      return this.transformEndResult(args.shift().reduce(this.processSubstitutions.bind(this, args)));</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'interimTag',
    value: <span class="fstat-no" title="function not covered" >function interimTag(previousTag, template) {</span>
<span class="cstat-no" title="statement not covered" >      for (var _len3 = arguments.length, substitutions = Array(_len3 &gt; 2 ? _len3 - 2 : 0), _key3 = 2; _key3 &lt; _len3; _key3++) {</span>
<span class="cstat-no" title="statement not covered" >        substitutions[_key3 - 2] = arguments[_key3];</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.tag(_templateObject, previousTag.apply(undefined, [template].concat(substitutions)));</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    value: <span class="fstat-no" title="function not covered" >function processSubstitutions(substitutions, resultSoFar, remainingPart) {</span>
<span class="cstat-no" title="statement not covered" >      var substitution = this.transformSubstitution(substitutions.shift(), resultSoFar);</span>
<span class="cstat-no" title="statement not covered" >      return resultSoFar + substitution + remainingPart;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    value: <span class="fstat-no" title="function not covered" >function transformSubstitution(substitution, resultSoFar) {</span>
<span class="cstat-no" title="statement not covered" >      var cb = <span class="fstat-no" title="function not covered" >function cb(res, transform) {</span></span>
<span class="cstat-no" title="statement not covered" >        return transform.onSubstitution ? transform.onSubstitution(res, resultSoFar) : res;</span>
      };
<span class="cstat-no" title="statement not covered" >      return this.transformers.reduce(cb, substitution);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    value: <span class="fstat-no" title="function not covered" >function transformEndResult(endResult) {</span>
<span class="cstat-no" title="statement not covered" >      var cb = <span class="fstat-no" title="function not covered" >function cb(res, transform) {</span></span>
<span class="cstat-no" title="statement not covered" >        return transform.onEndResult ? transform.onEndResult(res) : res;</span>
      };
<span class="cstat-no" title="statement not covered" >      return this.transformers.reduce(cb, endResult);</span>
    }
  }]);
  return TemplateTag;
}();
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 18 2017 20:27:31 GMT+0000 (UTC)</div>
</div>
</body>
</html>
