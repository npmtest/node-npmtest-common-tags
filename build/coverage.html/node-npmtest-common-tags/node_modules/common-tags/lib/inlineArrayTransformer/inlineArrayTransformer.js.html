...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-common-tags/node_modules/common-tags/lib/inlineArrayTransformer/inlineArrayTransformer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-common-tags/node_modules/common-tags/lib/inlineArrayTransformer/inlineArrayTransformer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-common-tags/node_modules/common-tags/lib/inlineArrayTransformer/</a> &#187; inlineArrayTransformer.js</div>
</div>
<div class="body">
...
var inlineArrayTransformer = function inlineArrayTransformer() {
  ...
  return {
    onSubstitution: <span class="fstat-no" title="function not covered" >function onSubstitution(substitution, resultSoFar) {</span>
      // only operate on arrays
<span class="cstat-no" title="statement not covered" >      if (Array.isArray(substitution)) {</span>
<span class="cstat-no" title="statement not covered" >        var separator = opts.separator;</span>
<span class="cstat-no" title="statement not covered" >        var conjunction = opts.conjunction;</span>
<span class="cstat-no" title="statement not covered" >        var serial = opts.serial;</span>
        // join each item in the array into a string where each item is separated by separator
        // be sure to maintain indentation
<span class="cstat-no" title="statement not covered" >        var indent = resultSoFar.match(/(\s+)$/);</span>
<span class="cstat-no" title="statement not covered" >        if (indent) {</span>
<span class="cstat-no" title="statement not covered" >          substitution = substitution.join(separator + indent[1]);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          substitution = substitution.join(separator + ' ');</span>
        }
        // if conjunction is set, replace the last separator with conjunction
<span class="cstat-no" title="statement not covered" >        if (conjunction) {</span>
<span class="cstat-no" title="statement not covered" >          var separatorIndex = substitution.lastIndexOf(separator);</span>
<span class="cstat-no" title="statement not covered" >          substitution = substitution.substr(0, separatorIndex) + (serial ? separator : '') + ' ' + conjunction + substitution.substr(separatorIndex + 1);</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      return substitution;</span>
    }
  };
};
&nbsp;
